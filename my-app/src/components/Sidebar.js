...
const Sidebar = ({ onSectionChange }) => (
  ...
  <div className="sideBar">
    ...
    <NavLink id="sideTextCenter" section="section2" icon="user-solid.svg" text="個人資訊" onClick={() => onSectionChange('section2', '個人資訊 | 使用者資料')} />
    <NavLink id="sideTextCenter" section="section3" icon="shield-dog-solid.svg" text="寵物資訊" onClick={() => onSectionChange('section3', '寵物資訊 | 愛寵資料卡')} />
    <NavLink id="sideTextCenter" section="section4" icon="money-bill-solid.svg" text="訂單管理" onClick={() => onSectionChange('section4', '訂單管理 | 歷史資料')} />
